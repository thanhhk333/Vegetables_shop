...
<html>
    <head>
        ...
        <link href="{{asset('css/products/style.css')}}" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn bg-white" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href={{route('layouts.app')}} class="navbar-brand ms-4 ms-lg-0">
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href={{route('feature.index')}} class="dropdown-item">Our Features</a>
        ...
        {{-- <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="{{route('layouts.app')}}"><img width="250" src="{{asset('images/logo.png')}}" alt="" /></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ route('layouts.app') }}">Home <span class="sr-only">(current)</span></a>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        <br>Distributed By: <a href="#" target="_blank">Team 2</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{asset('css/wow/wow.min.js')}}"></script>
