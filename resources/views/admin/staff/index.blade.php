                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">SDT</th>
                                        <th scope="col">Ngày nhận việc</th>
                                        <th scope="col">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($viewData['staff'] as $staff)
                                        <tr>
                                            <th scope="row">{{ $staff->getId }}</th>
                                            <td>{{ $staff->getName }}</td>
                                            <td>{{ $staff->getPhone }}</td>
                                            <td>{{ $staff->getStartIn }}</td>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('admin.staff.store') }}">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-auto">
                                <label for="inputtext6" class="col-form-label">MÃ NV</label>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-auto">
                                <label for="inputtext6" class="col-form-label">Tên NV</label>
                            </div>
                            <div class="col-auto">
                                <input type="text" id="inputtext6" class="form-control" aria-labelledby="textHelp"
                                    value="{{ old('name') }}" />
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-auto">
                                <label for="inputtext6" class="col-form-label">Vi Tri</label>
                            </div>
                            <div class="col-auto">
                                <input type="text" id="inputtext6" class="form-control" aria-labelledby="textHelp"
                                    value="{{ old('position') }}" />
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-auto">
                                <label for="inputtext6" class="col-form-label">Ngay Nhan Viec</label>
                            </div>
                            <div class="col-auto">
                                <input type="date" id="inputtext6" class="form-control" aria-labelledby="textHelp"
                                    value="{{ old('start_in') }}" />
                            </div>
                        </div>
